...
namespace Gighub.Migrations
{
    ...
    [Migration("20201118223444_ChangeRelationBetweenArtistAndGig")]
    partial class ChangeRelationBetweenArtistAndGig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gighub.Models.Entities.Following", b =>
                {
            ...
            modelBuilder.Entity("Gighub.Models.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<DateTime?>("OriginalDateTime")
                        .HasColumnName("originaldatetime")
                        .HasColumnType("timestamp without time zone");

                    b.Property<string>("OriginalVenue")
                        .HasColumnName("originalvenue")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Gighub.Models.Entities.UserNotification", b =>
                {
            ...
            modelBuilder.Entity("Gighub.Models.Entities.Following", b =>
                {
                    b.HasOne("Gighub.Models.Entities.ApplicationUser", "Followee")
                        .WithMany("Followees")
                        .HasForeignKey("FolloweeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Gighub.Models.Entities.ApplicationUser", "Follower")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("Gighub.Models.Entities.UserNotification", b =>
                {
                    b.HasOne("Gighub.Models.Entities.Notification", "Notification")
                        .WithMany()
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gighub.Models.Entities.ApplicationUser", "User")
